...
function setCookieConsent(consent) {
  ...
  document.addEventListener("DOMContentLoaded", function() {
    // Para WhatsApp: se define el mensaje y se concatena al URL base.
    var whatsappMessage = "Hola, estoy interesado en obtener información sobre sus servicios. ";
    var baseWhatsApp = "https://wa.me/541128596257?text=";
    var fullWhatsApp = baseWhatsApp + encodeURIComponent(whatsappMessage);
    
    // Actualiza el href en ambos enlaces de WhatsApp.
    document.getElementById("whatsappLink").href = fullWhatsApp;
    document.getElementById("whatsappCard").href = fullWhatsApp;
  
    // Para Facebook: se utiliza la URL "amigable" del HTML pero se redirige a la URL completa almacenada en data-full-url.
    var facebookLink = document.getElementById("facebookLink");
    facebookLink.addEventListener("click", function(e) {
      e.preventDefault();
      window.open(this.dataset.fullUrl, "_blank");
    });
  });
